...
<実装した機能について、それぞれどのような特徴があるのかを列挙する形で記載。画像はGyazoで、GIFはGyazoGIFで撮影すること。><br>
ユーザー管理機能<br>
タスク管理機能<br>
リマインダー機能<br>
進捗報告機能<br>
...
## 工夫したポイント
ユーザー管理機能：アイコン画像、権限IDの付与<br>
タスク管理機能：担当者と管理者（ユーザー管理機能の権限ID）を関連付け<br>
リマインダー機能：設定日時にトップページにポップアップ表示<br>
進捗報告機能：進捗情報（進捗率）から進捗状況（全体進捗と内訳）の表示<br>
チャット機能：<br>
